...
opts.Display = 'Off';
opts.Lower = [a 1 0.75 0.25];
opts.Upper = [150 25 1 0.7];
...
fitthresh=fitthresh-50

%old way of saving to text
%save('Thresh.txt', 'fitthresh', '-ASCII','-append');
%save('Slope.txt', 'PsychSlope', '-ASCII','-append');

%% new way of saving to text

fid1 = fopen('Thresh.txt','a+');
fprintf(fid1,'%4.4f\n',fitthresh);
fclose(fid1);

fid1 = fopen('Slope.txt','a+');
fprintf(fid1,'%4.4f\n',PsychSlope);
fclose(fid1);
