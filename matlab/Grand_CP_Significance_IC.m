% clear, close
%THIS SCRIPT IS FOR THE IC, 108 nuerons in total
...
sig_tot = cat(1,sig_a,sig_b,sig_c,sig_d); %All indeces in for significant CP's in the IC
