...
% 090812 JR Use dataTag as outputprefix if non was passed instead of chrashing 
 MyTank = ['C:\My Documents\Experiments\Behavior\Alpha\ex110906\tank110906a'];
    MyBlock = ['~OurData-' 3];
switch computer
    case 'PCWIN'
    case 'PCWIN64'
...
% % the sumption here is that there is only one tank in a directory and
 ...
 e=invoke(TT,'OpenTank',MyTank,'R');%PLACE PATH OF TANK TO COLLECT DATA FROM
...
pause(1)
e=invoke(TT,'SelectBlock',MyBlock);%PLACE NAME OF BLOCK
if e==0
