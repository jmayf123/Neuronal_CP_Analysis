function [Sound] = Monkey2Klattah_Test(vowel)
switch vowel
    ...
    case 5 %Vowel ooh
        ...
        Sound='Ooh';
            %F =  [502, 2005, 2667, 3479]; % Formant frequencies (Hz) original 700 1220 2600
        %BW = [ 80, 122,   196,  323];  % Formant bandwidths (Hz) original 130 70 160   
    otherwise
end
...
% dir2=['C:\Documents and Settings\user1\My Documents\GUIde\',Sound, ' waveform.txt'];
% fid2=fopen(dir2,'w');
% length(new_data);
