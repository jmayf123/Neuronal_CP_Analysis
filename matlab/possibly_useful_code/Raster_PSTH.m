...
BLOCKPATH = ('X:\Delta data\Neurobehavior\IC\ex120907\tank120907d\OurData-7');
...
%REF_EPOC = data.epocs.Freq;
%REF_EPOC = num2str(data.epocs.Freq.onset);
%REF_EPOC = data.epocs.Freq.data;
%REF_EPOC = data.epocs.Freq.type;
%REF_EPOC = data.epocs.Freq.type;
%REF_EPOC = data.epocs.Freq.onset;
%REF_EPOC = 'data.epocs.Freq.onset(1,1)';
%REF_EPOC = num2str(data.epocs.Freq.onset(1,1));
