function MonkeyGUIBuild(Task, handles)
...
ToneList={'-16 dB';'-13 dB';'-10 dB';'-6 dB';'-3 dB';'0 dB';'4 dB';'7 dB';'10 dB';'14 dB';'17 dB';'20 db';'24 db';'Big 1';'Catch 1'; 'Catch 2'; 'Catch 3'; 'Catch 4'; 'Catch 5'; 'Catch 6'; 'Catch 7'; 'Catch 8'; 'Catch 9'; 'Catch 10'};
NoiseList={'+0dB';'+10dB (.0079V)';'+20dB (.025V)'};
...
ModFreq={'0 Hz'; '10 Hz'; '20 Hz';'40 Hz';'50 Hz';'70.7 Hz';'80 Hz';'84.1 Hz';'100 Hz';'141.4 Hz';'200 Hz'};
